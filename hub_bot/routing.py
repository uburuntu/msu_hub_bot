...
from common.tg.state import UpdateStateContext
from msu_hub_bot.settings import Settings
from hub_bot.utils.wit import Wit
from hub_bot.utils.wolfram import WolframAPI
from hub_bot.commands.control import process_start, process_cancel, process_echo, process_error, process_expired_callback
from hub_bot.commands.admin import (
    process_ban,
...
from hub_bot.commands.animate import process_animate, process_matrix
from hub_bot.commands.antibot import AntiBot
from hub_bot.commands.arxiv import process_arxiv
from hub_bot.commands.camera import Camera
from hub_bot.commands.crypto import Crypto
from hub_bot.commands.debate import Debate
from hub_bot.commands.debug import process_delete_after, process_json, process_logs
from hub_bot.commands.dvach import Dvach
from hub_bot.commands.errors import process_error_stickers, process_donate, process_supporters
from hub_bot.commands.excuses import process_excuse
from hub_bot.commands.externals import (
    process_bg,
    process_porfirevich,
    process_topdf,
    process_imgur,
...
from hub_bot.commands.infra import (
...
from hub_bot.commands.latex import Latex
from hub_bot.commands.likes import Like
from hub_bot.commands.lingvanex import process_langs, process_translate, process_en, process_ru
from hub_bot.commands.lobster import process_lobster, process_demotivator, process_atmta, process_atmta_v
from hub_bot.commands.location import process_location
from hub_bot.commands.minecraft import MinecraftStatus
from hub_bot.commands.other import (
    process_me,
...
from hub_bot.commands.personal import process_sanya, process_dyubs, process_pookie_pook, process_popov
from hub_bot.commands.posting import process_post_all, process_post_forward_all, MakePost, MakePostStates
from hub_bot.commands.prog import ProgCompiler, ProgStates, process_code, register_code_submitters, register_code_submitters_with_stdin
from hub_bot.commands.raffle import Raffle
from hub_bot.commands.rate import Rate
from hub_bot.commands.rolls import (
    Randoms,
    Rolls,
    process_d6,
    process_dice,
...
from hub_bot.commands.sed import process_sed
from hub_bot.commands.settings import process_settings
from hub_bot.commands.song import process_song
from hub_bot.commands.stats import Stats
from hub_bot.commands.sticker import (
    process_sticker,
...
from hub_bot.commands.tenet import process_reverse
from hub_bot.commands.tesseract import process_image_to_text
from hub_bot.commands.tts import process_tts
from hub_bot.commands.tyan import Tyan
from hub_bot.commands.vk import process_list_vk_wall, process_vk_wall, process_vk_post
from hub_bot.commands.votes import process_votes
from hub_bot.commands.weather import Weather, WeatherMap
from hub_bot.commands.zalgo import process_zalgo
